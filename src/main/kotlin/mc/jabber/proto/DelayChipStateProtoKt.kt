...
inline fun delayChipStateProto(block: mc.jabber.proto.DelayChipStateProtoKt.Dsl.() -> Unit): mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto =
    mc.jabber.proto.DelayChipStateProtoKt.Dsl._create(mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.newBuilder())
        .apply { block() }._build()
...
object DelayChipStateProtoKt {
    ...
    class Dsl private constructor(
        ...
        companion object {
            @kotlin.jvm.JvmSynthetic
            @kotlin.PublishedApi
            internal fun _create(builder: mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.Builder): Dsl =
                Dsl(builder)
        }
        ...
        fun com.google.protobuf.kotlin.DslList<mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry, EntriesProxy>.add(
            value: mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry
        ) {
        ...
        inline operator fun com.google.protobuf.kotlin.DslList<mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry, EntriesProxy>.plusAssign(
            value: mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry
        ) {
            add(value)
        }
        ...
        fun com.google.protobuf.kotlin.DslList<mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry, EntriesProxy>.addAll(
            values: kotlin.collections.Iterable<mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry>
        ) {
        ...
        operator fun com.google.protobuf.kotlin.DslList<mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry, EntriesProxy>.set(
            index: kotlin.Int,
            value: mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry
        ) {
    ...
    inline fun entry(block: mc.jabber.proto.DelayChipStateProtoKt.entryKt.Dsl.() -> Unit): mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry =
        mc.jabber.proto.DelayChipStateProtoKt.entryKt.Dsl._create(mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry.newBuilder())
            .apply { block() }._build()
    ...
    object entryKt {
        ...
        class Dsl private constructor(
            ...
            companion object {
                @kotlin.jvm.JvmSynthetic
                @kotlin.PublishedApi
                internal fun _create(builder: mc.jabber.proto.DelayChipStateBuffer.DelayChipStateProto.entry.Builder): Dsl =
                    Dsl(builder)
            }
            ...
            var remainingDelay: kotlin.Int
                ...
                get() = _builder.remainingDelay
                @JvmName("setRemainingDelay")
                set(value) {
                    _builder.remainingDelay = value
                }
