...
inline fun circuitBoardProto(block: mc.jabber.proto.CircuitBoardProtoKt.Dsl.() -> Unit): mc.jabber.proto.CircuitBoardBuffer.CircuitBoardProto =
  mc.jabber.proto.CircuitBoardProtoKt.Dsl._create(mc.jabber.proto.CircuitBoardBuffer.CircuitBoardProto.newBuilder()).apply { block() }._build()
object CircuitBoardProtoKt {
  ...
  class Dsl private constructor(
    ...
    companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: mc.jabber.proto.CircuitBoardBuffer.CircuitBoardProto.Builder): Dsl = Dsl(builder)
    }
