...
inline fun cardinalDataProto(block: mc.jabber.proto.CardinalDataProtoKt.Dsl.() -> Unit): mc.jabber.proto.CardinalDataBuffer.CardinalDataProto =
    mc.jabber.proto.CardinalDataProtoKt.Dsl._create(mc.jabber.proto.CardinalDataBuffer.CardinalDataProto.newBuilder())
        .apply { block() }._build()
...
object CardinalDataProtoKt {
    ...
    class Dsl private constructor(
        ...
        companion object {
            @kotlin.jvm.JvmSynthetic
            @kotlin.PublishedApi
            internal fun _create(builder: mc.jabber.proto.CardinalDataBuffer.CardinalDataProto.Builder): Dsl =
                Dsl(builder)
        }
